...
exports.DEFAULT_PLAYER_LIST = void 0;
exports.DEFAULT_PLAYER_LIST = {
  genshin: {
    keyword: "原神",
    nickname: "原神玩家"
  }
...
class App {
  constructor(theme) {
    ...
    this.isPlayer = new Map();
    this.notPlayer = new Set();
    this.isNewVersionBilibili = document.getElementsByClassName("item goback").length != 0; // 检测是不是新版

    this.getIndicator = config_1.getIndicator;
    theme !== undefined ? this.theme = theme : this.theme = new config_1.Theme();
    this.playerList = exports.DEFAULT_PLAYER_LIST; //TODO: 以后可以自定义
  }
        ...
        commentlist.forEach(user => {
          ...
          if (this.isPlayer.has(pid)) {
            ...
            for (let type of PLAYER_KEYS) {
              let indicator = config_1.getIndicator(type, this.theme);

              if (!user.textContent.includes(this.playerList[type].nickname) && this.isPlayer.get(pid).get(type)) {
...
exports.getIndicator = exports.Theme = void 0; // 默认部分

const DEFAULT_TAG = "span";
const DEFAULT_STYLE = "padding: 1px 5px; font-size: 0.677rem; border-radius: 2px; margin-left: 5px; ";
...
const app_1 = __webpack_require__(1); // 主题


class Theme {
  constructor(tag, style, colors, nicknames) {
    this.tag = DEFAULT_TAG;
    this.style = DEFAULT_STYLE;
    this.colors = DEFAULT_COLOR_LIST;
    this.playerList = app_1.DEFAULT_PLAYER_LIST;
...
function getIndicator(type, theme) {
