...
* */
export declare var unsafeWindow: Window;

/*
获取有关脚本和 TM 的一些信息。
* */
export declare var GM_info: {
    version: string,
...
* */
export declare function GM_addElement(tag_name: string, attributes: object)

/*
创建一个由“tag_name”指定的 HTML 元素并应用所有给定的“属性”并返回注入的 HTML 元素。如果给出了“parent_node”，则将其附加到它或以其他方式附加到文档头或体。
* */
export declare function GM_addElement(parent_node: HTMLElement, tag_name: string, attributes: object)
...
* */
export declare function GM_addValueChangeListener(name: string, listener: GM_Types.ValueChangeListener): number;
...
从存储中获取 'name' 的值。
* */
export declare function GM_getValue(name: string, defaultValue ?: any): any;

/*
将消息打印到控制台。
* */
export declare function GM_log(message: string): any;
...
* */
export declare function GM_registerMenuCommand(name: string, listener: Function, accessKey ?: string): number;

/*
使用给定的菜单命令 ID 取消注册先前由 GM_registerMenuCommand 注册的菜单命令。
* */
export declare function GM_unregisterMenuCommand(id: number): void;

/*
使用此 url 打开一个新选项卡。
* */
export declare function GM_openInTab(url: string, options: GM_Types.OpenTabOptions): void;
/*
使用此 url 打开一个新选项卡。
* */
...
使用此 url 打开一个新选项卡。
* */
export declare function GM_openInTab(url: string): void;

/*
创建一个 xmlHttpRequest。
* */
export declare function GM_xmlhttpRequest<CONTEXT_TYPE>(details: GM_Types.XHRDetails<CONTEXT_TYPE>): GM_Types.AbortHandle<void>;

/*
将给定的 URL 下载到本地磁盘。
* */
export declare function GM_download(details: GM_Types.DownloadDetails): GM_Types.AbortHandle<boolean>;
/*
将给定的 URL 下载到本地磁盘。
* */
export declare function GM_download(url: string, filename: string): GM_Types.AbortHandle<boolean>;

/*
只要此选项卡处于打开状态，就获取一个持久对象。
* */
export declare function GM_getTab(callback: (obj: object) => any): void;

/*
保存选项卡对象以在页面卸载后重新打开它。
* */
export declare function GM_saveTab(obj: object): void;

/*
获取所有选项卡对象作为散列以与其他脚本实例通信。
* */
export declare function GM_getTabs(callback: (objs: { [key: number]: object }) => any): void;

/*
显示 HTML5 桌面通知和/或突出显示当前选项卡。
* */
export declare function GM_notification(details: GM_Types.NotificationDetails, ondone: Function): void;
/*
显示 HTML5 桌面通知和/或突出显示当前选项卡。
* */
...
* */
export declare function GM_setClipboard(data: string, info ?: string | { type?: string, mimetype?: string }): void;

export declare namespace GM_Types {
